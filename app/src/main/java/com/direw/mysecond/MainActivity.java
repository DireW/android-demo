...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authorizeButton = findViewById(R.id.authorize_id);
        authorizeButton.setOnClickListener(c -> {
            Intent intent = new Intent();
            intent.setData(Uri.parse("direw://pull.second/auth?type=1"));
            intent.putExtra("from", "wx_demo");
